<div class="flex gap-1.5 items-center py-8 pr-6 pl-6 mt-5 w-full leading-none text-black bg-lime-100 rounded-3xl min-h-[105px] max-md:px-5 max-md:max-w-full">
    <div class="flex flex-wrap flex-1 shrink gap-10 justify-between items-center self-stretch my-auto w-full basis-0 min-w-[240px] max-md:max-w-full">
      <div class="flex flex-col self-stretch my-auto min-w-[240px] w-[269px]">
