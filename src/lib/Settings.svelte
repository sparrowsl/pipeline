...
>
  ...
  >
    <div class="mt-8 flex flex-col">
      <Label for="currentPassword" class="text-xl font-semibold text-black max-md:mb-2"
  ...
  >
    <div class="mt-8 flex flex-col">
      <Label for="newPassword" class="text-xl font-semibold text-black max-md:mb-2"
        >New Password</Label
      >
    </div>
    <div class="w-2/3 max-md:w-full">
  ...
  <div class="flex w-full flex-row items-start justify-between max-md:flex-col max-md:items-start">
    <div class="mt-8 flex flex-col">
      <Label for="confirmPassword" class="text-xl font-semibold text-black max-md:mb-2"
  ...
  <Button
    class="mt-8 self-end rounded-[128px] bg-lime-800 px-16 py-2 text-xl whitespace-nowrap text-white max-lg:w-[30%] max-lg:py-3 max-lg:text-base max-md:w-[45%] max-md:px-5"
  >
    Done
  </Button>
