<form class="flex w-[79%] flex-col text-3xl text-black max-md:max-w-full">
  <div
  ...
  <button
    class="mt-8 self-end whitespace-nowrap rounded-[128px] bg-lime-800 px-16 py-6 text-xl text-white max-md:px-5"
  >
    Done
  </button>

  <button
    class="mt-8 min-h-[73px] w-full gap-1 self-stretch rounded-[82px] bg-teal-900 px-10 py-7 text-xl text-white max-md:max-w-full max-md:px-5"
  >
    Delete Account
  </button>
</form>
