  ...
  <div class="w-[996px] mx-auto p-6">
      ...
      <div class="mb-6">
          ...
          <div class="grid grid-cols-3 gap-2">
           <button class={`flex items-center justify-center p-2 space-x-2 border rounded-full hover:bg-gray-50 ${
      ...
      {#if selectedTab === 'Card'}
          ...
          <div class="mb-4">
              ...
              <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={cardNumber} placeholder="XXXX XXXX XXXX XXXX" />
          </div>
          <div class="grid grid-cols-2 gap-2 mb-4">
              <div>
                  <label class="block mb-1 text-sm text-gray-600">Expiry</label>
                  <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={expiry} placeholder="MM / YY" />
              </div>
              <div>
                  <label class="block mb-1 text-sm text-gray-600">CVC</label>
                  <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={cvc} placeholder="CVC" />
              </div>
          </div>
          ...
          <div class="grid grid-cols-2 gap-2 mb-4">
            ...
            <div>
                ...
                <input type="number" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={zip} placeholder="ZIP" />
            </div>
        </div>
      ...
      <div class="mb-4">
        ...
        <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={name} placeholder="Enter account holder's name" />
    </div>
    <div class="mb-4">
        <label class="block mb-1 text-sm text-gray-600">Routing Number</label>
        <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={routingNumber} placeholder="Enter routing number" />
    </div>
    <div class="mb-4">
        <label class="block mb-1 text-sm text-gray-600">Checking Account Number</label>
        <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={checkingAccount} placeholder="Enter checking account number" />
    </div>
    <div class="mb-4">
        <label class="block mb-1 text-sm text-gray-600">ID Number</label>
        <input type="text" class="w-full p-2 bg-gray-100 border-2 border-[#0b383c] rounded-full focus:outline-none focus:border-[#0b383c] transition-colors duration-200" bind:value={idNumber} placeholder="Enter ID number" />
    </div>
