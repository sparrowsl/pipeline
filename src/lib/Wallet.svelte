    ...
    <div class="mt-20 flex w-full flex-col self-stretch">
      ...
      <div class="mt-24 flex w-full max-w-full flex-col self-center sm:mt-10">
        ...
        <input
          type="text"
          id="amount"
          class="mt-8 h-[67px] w-full gap-1.5 self-stretch rounded-[50px] border-[3px] border-solid border-lime-800 py-3 pl-7 pr-16 text-3xl font-thin max-md:h-[50px] sm:max-w-full sm:px-5 sm:text-lg"
          placeholder="$ USDC"
        />
      </div>
