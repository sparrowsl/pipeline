...
<div class="w-full bg-[#d1ea9a]/90 py-16">
  <div class="max-w-4xl mx-auto text-center">
    <h1 class="font-['Inter'] text-5xl font-semibold leading-[54.51px] text-[#08292c] max-lg:text-2xl">
...
<div class="mx-auto mt-12 flex w-[90%] justify-center space-x-6 rounded-full border-2 border-[#0b383c] py-1 sm:w-[75%] md:w-[50%]">
  {#each steps as step, index}
    <button
      class="w-[45%] rounded-full border-2 px-4 py-4 text-xl font-semibold transition duration-300 sm:w-[47%] sm:px-5 sm:py-5 sm:text-2xl md:px-6 md:py-6
        ...
        : 'border-none text-[#0b383c] opacity-50 cursor-not-allowed'}"
