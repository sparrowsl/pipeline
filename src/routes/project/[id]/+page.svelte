...
<!-- <div class="flex items-start max-w-[1500px] mx-auto px-4 md:flex-row flex-col">
    ...
    {#if user}
      <div class="mt-6 flex items-center gap-3">
        ...
        {:else}
          ...
          <button
            on:click={toggleFollow}
            class="w-full rounded-full border-2 py-4 text-center text-base font-semibold lg:w-[50%]"
            class:bg-[#e9f5d3]={isFollowing}
            class:text-black={isFollowing}
          >
            {isFollowing ? 'UNFOLLOW' : 'FOLLOW'}
