...
<!-- Highlight Card -->
<div class="rounded-2xl bg-dashboard-yellow-400 p-6 text-dashboard-black shadow-card">
...
<!-- Primary Button -->
<button
  class="rounded-xl bg-dashboard-black px-6 py-3 text-label-lg font-medium text-white transition-colors hover:bg-dashboard-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
>
  Primary Action
</button>
...
<!-- Accent Button -->
<button
  class="rounded-xl bg-dashboard-yellow-400 px-6 py-3 text-label-lg font-medium text-dashboard-black transition-colors hover:bg-dashboard-yellow-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
>
  Get Started
</button>
...
>
  <div class="flex items-center space-x-3">
    <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-dashboard-yellow-400">
...
<form class="space-y-6">
  ...
  <button
    class="w-full rounded-xl bg-dashboard-yellow-400 px-6 py-3 text-label-lg font-medium text-dashboard-black transition-colors hover:bg-dashboard-yellow-500"
  >
    Create Account
  </button>
</form>
